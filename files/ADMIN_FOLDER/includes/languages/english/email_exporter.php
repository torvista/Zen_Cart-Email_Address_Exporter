...
define('TEXT_EMAIL_EXPORTER_FORMAT', 'Export File Format:');
define('TEXT_PLEASE_SELECT_AUDIENCE', 'Select a audience list:');
define('TEXT_EMAIL_EXPORTER_FILENAME', 'Export Filename:');
define('TEXT_EMAIL_EXPORTER_SAVETOFILE','Save to server (otherwise download to another location)');
define('TEXT_EMAIL_EXPORTER_DEST','File location: ');
